...
// Metadata contains a selection of metadata that can be
type Metadata interface {
	...
	// PrivateData is used on MP3's downloaded from Google Play;
	// it usually contains the client ID:
	//
	//  Google/OriginalClientId=`JanQsirFMsrrsfq/Irefzq'
	//
	PrivateData() []byte
}
